             ...
             <div class=" col-md-6 d-inline mt-5">
               <form action="" method="POST" class="font-weight-bold">
                 <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" readonly class="form-control" value="<?php echo $_GET['bid'];?>"></input>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="bookname" class="col-sm-3 col-form-label ">Book Name</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php echo $b_name;?>" name="bookname"></input>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="authors" class="col-sm-3 col-form-label ">Authors</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php echo $authors;?>" name="authors"></input>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control font-weight-bold" value="<?php echo $quantity ;?>"name="quantity"></input>
                  </div>
                </div>
                <div class="form-group row">
